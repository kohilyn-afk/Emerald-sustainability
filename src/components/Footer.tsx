      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 justify-between">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-xs text-[#b2c5b9] max-w-sm leading-relaxed">
              FCCA, CA(M), BA(Hons) UK, Oxford-Certified Sustainability Specialist providing direct, agile 1-on-1 advisory for Malaysian C-suites, CFOs, and Board Directors.
            </p>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li><a href="#diagnostic" className="hover:text-[#f3d38c] transition-colors">AI ESG Diagnostic</a></li>
              <li><a href="#roi-calculator" className="hover:text-[#f3d38c] transition-colors">Carbon & Financial ROI Simulator</a></li>
              <li><a href="#live-prototype" className="hover:text-[#f3d38c] transition-colors">Executive Prototype Suite</a></li>
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="p-3.5 rounded-xl bg-[#0e2117] border border-[#224835] text-xs space-y-1.5">
              <div className="text-[#e2f1e8] font-semibold">Bursa Malaysia & ISSB (IFRS S1/S2) Compliant</div>
              <div className="text-[11px] text-[#b2c5b9] leading-tight">
                Aligning corporate carbon inventories, MFRS general ledger closing, and TNB utility pipelines.
              </div>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-[#1f4230] flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px]">
          <div>
            © {new Date().getFullYear()} Koh I-Lyn & Co. All rights reserved. Pastel Dark Forest Green & Gold Palette.
          </div>
