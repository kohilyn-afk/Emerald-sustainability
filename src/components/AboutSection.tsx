...
import { User, CheckCircle2, ShieldCheck, Mail, Linkedin, Award, Compass, ArrowUpRight } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 forest-card rounded-2xl p-8 border border-[#e5b958]/35 space-y-6 relative overflow-hidden">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#1d4631] to-[#0e2117] border border-[#e5b958]/50 flex items-center justify-center text-[#f3d38c] text-2xl font-bold font-display shadow-lg">
                KL
              </div>
              <div>
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 py-2.5 rounded-xl text-xs font-bold text-[#f2faf5] bg-[#143122] hover:bg-[#1b402d] border border-[#90d0a7]/35 transition-all flex items-center justify-center gap-2"
              >
              ...
              <a
                ...
                className="flex-1 py-2.5 rounded-xl text-xs font-bold gold-gradient-btn transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#143122] border border-[#e5b958]/35 text-[#f3d38c] text-xs font-semibold">
              ...
              <span>Independent Advisory Philosophy</span>
            </div>

            <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-[#f2faf5] leading-tight">
              Direct, Agile, 1-on-1 Counsel for C-Suites & Board Directors
            </h2>

            <div className="space-y-4 text-sm text-[#b2c5b9] leading-relaxed">
              <p>
                As an independent advisor, I work directly with leadership teams to bridge the gap between environmental sustainability mandates and MFRS financial accounting controls. You get high-level strategic counsel and precise technical execution without delegating to junior associates.
              </p>
              <p>
                Malaysian corporations face unprecedented reporting pressures under the Bursa Malaysia Sustainability Reporting Guide and ISSB standards. My practice focuses on unifying general ledger closing workflows, automated utility pipelines, and board-level risk management.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-[#1f4230]">
              <div className="p-4 rounded-xl bg-[#143122] border border-[#90d0a7]/30 space-y-1">
                ...
                <div className="text-xs text-[#e2f1e8]">Direct 1-on-1 collaboration with Koh I-Lyn for all technical deliverables.</div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#143122] border border-[#e5b958]/30 space-y-1">
                ...
                <div className="text-xs text-[#e2f1e8]">Combining Chartered Accountant CA(M) rigor with Oxford-certified sustainability expertise.</div>
              </div>
            </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="px-6 py-3.5 rounded-xl text-xs font-bold gold-gradient-btn transition-all font-mono uppercase tracking-wider gold-glow"
              >
                Schedule Confidential Initial Consultation
              </button>
            </div>
